...
class EMReaderBase():
    ...
    def __init__(self, file, source_type, fast_random_access, buffer_size=DEFAULT_BUFFER_SIZE):
...
class SEQReader(EMReaderBase):
    ...
    def __init__(self, file, source_type, buffer_size=DEFAULT_BUFFER_SIZE):
        try:
            import pims
            self._pims = pims
        except ImportError:
            ...
            return
        EMReaderBase.__init__(self, file, source_type, False, buffer_size)
