...
class InputParams():
    ...
    def _validate_input_params(self):
        ...
        if self._param_map['rc_operation_mode'] not in [0,1,2] :
        ...
        self._param_map['source_numpy_dtype'] = map_dtype(self._param_map['source_data_type'], self._param_map['source_bit_depth'])
        self._param_map['target_numpy_dtype'] = map_dtype(self._param_map['target_data_type'], self._param_map['target_bit_depth'])
